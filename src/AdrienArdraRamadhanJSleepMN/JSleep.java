...
public class JSleep {
    ...
    public static void main(String[] args) {
        ...
        Account testRegex = new Account("Adrien","adrienardra@gmail.com", "adRien100");
        Account testRegexFail =new Account("Adrien","adrien-ardra-ramadhan@gmail.com", "adrien100");
        System.out.println(testRegex.validate());
        System.out.println(testRegexFail.validate());
    }
